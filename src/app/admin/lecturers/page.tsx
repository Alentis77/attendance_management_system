            ...
            <div className="bg-white p-6 rounded-lg shadow mb-8">
                ...
                <form action={createLecturer} className="grid grid-cols-1 md:grid-cols-4 gap-4 items-end">
                    ...
                    <div>
                        ...
                        <input type="password" name="password" required className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm border p-2" />
                    </div>
                        ...
                        {lecturers.map((lecturer) => (
                            <tr key={lecturer._id.toString()}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <form action={deleteLecturer.bind(null, lecturer._id.toString())}>
