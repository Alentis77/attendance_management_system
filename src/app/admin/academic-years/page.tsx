    ...
    return (
        <div>
            ...
            <div className="bg-white p-6 rounded-lg shadow mb-8">
                <h2 className="text-lg font-semibold mb-4">Add New Academic Year</h2>
                <form action={createAcademicYear} className="flex gap-4 items-end">
                    <div>
                        ...
                        <input type="text" name="year" required className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm border p-2" />
                    </div>
                        ...
                        {years.map((year) => (
                            <tr key={year._id.toString()}>
                                ...
                                <td className="px-6 py-4 whitespace-nowrap text-right text-sm font-medium">
                                    <form action={deleteAcademicYear.bind(null, year._id.toString())}>
